...
|---------|-----------------|-----------|------|
| **フレームワーク** | Next.js | 15.4.7 | Webアプリケーションフレームワーク |
...
| **チャット機能** | Vercel AI SDK | ^5.0.43 | チャットインターフェース |
| **マークダウン** | react-markdown | ^10.1.0 | 回答の表示 |
| **デプロイ** | Vercel | - | 本番環境ホスティング |

> **バージョン情報について**: 上記のバージョン情報は package.json に記載されている実際のバージョンと一致しています（2025年10月12日時点）。
